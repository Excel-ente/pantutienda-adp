...
class configuracion(models.Model):
    ...
    unidad_de_medida_precio_venta = models.BooleanField(default=True,help_text='Permite Modificar la unidad de medida del precio del producto')
    ...
    limite_pedidos_pendientes = models.PositiveIntegerField(default=1,blank=False,null=False)
